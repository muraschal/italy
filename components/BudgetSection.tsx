...
const highlightCount = days.reduce((s, d) => s + d.events.filter(e => e.highlight).length, 0);
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-text-secondary text-sm sm:text-base font-light mt-3 tracking-wide">
            {days.length} Tage · {eventCount} Aktivitäten · {highlightCount} Highlights
          </p>
        </motion.div>
        ...
        >
          <div className="glass rounded-2xl p-6 inline-flex flex-col items-center border border-accent/[0.06]">
            ...
            <p className="text-[11px] text-text-muted mt-3 italic tracking-wide">
              Orientierungswerte — Schweizer und italienisches Preisniveau gemischt.
            </p>
          </div>
        </motion.div>
      </div>
