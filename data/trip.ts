...
export const locations: Location[] = [
  ...
  {
    id: "ascona",
    name: "Ascona — Piazza Motta",
    address: "Piazza G. Motta, 6612 Ascona",
    coordinates: { lat: 46.154, lng: 8.7705 },
    googleMapsUrl: "https://maps.google.com/?q=Piazza+Motta+Ascona",
    category: "landmark",
    photoSpot: true,
  ...
  {
    id: "seven-beachclub",
    name: "Seven Senses Beach Club",
    address: "Via Lido 84, 6612 Ascona",
    coordinates: { lat: 46.1474998, lng: 8.782188 },
    googleMapsUrl: "https://maps.google.com/?q=Seven+Senses+Beach+Club+Via+Lido+84+Ascona",
    category: "restaurant",
  },
  {
    id: "como",
  ...
  {
    id: "la-volta",
    name: "La Volta at RH Milan",
    address: "Corso Venezia 56, 20121 Milano",
    coordinates: { lat: 45.4738529, lng: 9.2046909 },
    googleMapsUrl: "https://maps.google.com/?q=La+Volta+RH+Milan+Corso+Venezia+56+Milano",
    category: "restaurant",
  },
  {
...
export const days: TripDay[] = [
  ...
  },
  {
    date: "2026-08-14",
    label: "Freitag",
    subtitle: "Verso il lago — Vormittag in Mergoscia, Beachclub in Ascona, Abend in Como",
    totalCost: 280,
    events: [
      {
        time: "~09:00",
      ...
      {
        time: "11:00",
        title: "Seven Senses Beach Club",
        description: "Reserviert · Liegen am Lido, Küche direkt am Wasser",
        locationId: "seven-beachclub",
        transport: "car",
        transportDuration: "~22 Min · 14 km",
        cost: 160,
        costNote: "Liegen, Lunch & Drinks für 2",
        highlight: true,
        icon: "waves",
        ticketRef: "seven-beachclub",
        funFact:
          "Das Lido liegt an der Mündung der Maggia — der Fluss schüttet seit Jahrhunderten Kies in den Lago Maggiore und hat die Bucht von Ascona überhaupt erst geformt.",
      },
      {
        time: "~16:30",
        title: "Ascona — Piazza Motta",
        description: "Dem Ufer entlang in den Ort · Seepromenade, Palmen, Pastellfassaden",
        locationId: "ascona",
        transport: "walk",
        transportDuration: "15 Min · 1,2 km",
        cost: null,
        highlight: false,
        icon: "mountain",
        funFact:
      ...
      },
      {
        time: "~20:30",
        title: "Cena in Como",
        description: "Noch offen — je nachdem, wo die Unterkunft am Ende liegt",
        locationId: "como",
        transport: "none",
        cost: 120,
        costNote: "Abendessen für 2 · Schätzung",
        highlight: false,
        icon: "utensils",
      },
    ],
  },
  {
    ...
    events: [
      ...
      {
        time: "19:45",
        title: "Cena — La Volta at RH Milan",
        description: "Reserviert · Gewölbe unter dem RH-Palazzo an der Corso Venezia",
        locationId: "la-volta",
        transport: "walk",
        transportDuration: "20 Min · 1,6 km",
        cost: 300,
        costNote: "Dinner & Wein für 2 · Schätzung",
        highlight: true,
        icon: "utensils",
        ticketRef: "la-volta",
        funFact:
          "Der Palazzo an der Corso Venezia gehörte einst dem Fürsten von Piombino. Das Restaurant liegt im Untergeschoss unter einem Gewölbe, der Innenhof darüber ist von einer Kuppel aus Bronze und Glas überspannt.",
      },
      {
        time: "~23:00",
        title: "Rückweg ins Hotel",
        description: "1,4 km zu Fuss durch die Altstadt — oder Taxi, je nach Abend",
        locationId: "sina-de-la-ville",
        transport: "walk",
        transportDuration: "18 Min · 1,4 km",
        cost: null,
        highlight: false,
        icon: "sparkles",
      },
...
export const tickets: Record<string, TicketInfo> = {
  "seven-beachclub": {
    title: "Seven Senses Beach Club — Lido Ascona",
    day: "Freitag",
    datetime: "Fr 14. Aug · 11:00 · 2 Personen",
    confirmed: true,
    refs: [],
    notes: [
      "Via Lido 84, 6612 Ascona · +41 91 780 77 07",
      "Zugang zum Restaurant ohne Lido-Eintritt",
      "Bei unsicherem Wetter kurz anrufen — die Öffnung hängt daran",
      "Zu Fuss 15 Min der Uferpromenade entlang zur Piazza Motta",
    ],
  },
  como: {
    title: "Como — 1 Nacht",
  ...
  "la-volta": {
    title: "La Volta at RH Milan — Cena",
    day: "Samstag",
    datetime: "Sa 15. Aug · 19:45 · 2 Personen",
    confirmed: true,
    refs: [],
    notes: [
      "Corso Venezia 56, 20121 Milano",
      "Im RH-Palazzo · das Restaurant liegt im Gewölbe des Untergeschosses",
      "20 Min zu Fuss vom Duomo, 18 Min zurück ins Hotel",
      "Auf dem Dach desselben Hauses liegt die RH Bar & Lounge",
    ],
  },
  "sina-de-la-ville": {
...
export const budgetOnSite: BudgetItem[] = [
  ...
  // Freitag
  { label: "Seven Senses Beachclub, Ascona (reserviert)", amount: 160, icon: "utensils" },
  { label: "Cena in Como (Schätzung)", amount: 120, icon: "utensils" },
  // Samstag
  { label: "Duomo Dachterrassen (2× Lift à 18 €)", amount: 36, icon: "landmark" },
  { label: "La Volta at RH Milan (reserviert · Schätzung)", amount: 300, icon: "utensils" },
  // Sonntag
